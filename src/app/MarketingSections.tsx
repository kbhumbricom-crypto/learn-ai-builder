...
export default function MarketingSections({ onCtaClick }: { onCtaClick?: () => void }) {
  ...
  return (
    <div style={{ position: 'relative', backgroundColor: 'transparent', overflow: 'hidden' }}>
      ...
      <style>{`
        .marketing-section {
          padding: 6rem clamp(1.2rem, 5vw, 2rem);
          display: flex;
      ...
      <section id="how-it-works" className="marketing-section">
        ...
        >
          ...
          <div style={{ textAlign: 'center', color: 'var(--color-text-muted)', fontSize: '0.9rem', marginBottom: '3rem', opacity: 0.8 }}>
            Watch LearnAI generate a complete, structured course from a single URL in real-time.
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', textAlign: 'left', marginBottom: '2rem' }}>
            ...
            <motion.div className="marketing-glass-card magnetic-card" variants={fadeInUp}>
              ...
              <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', lineHeight: 1.6 }}>A Maven bootcamp. An MIT OpenCourseWare page. A Coursera syllabus. If it has a curriculum, LearnAI can read it.</p>
            </motion.div>
      ...
      <section className="marketing-section">
        ...
        >
          ...
          <motion.div 
            ...
            variants={fadeInUp}
          >
            LearnAI doesn't add more content to the pile. It takes the content that already exists and teaches it the way that works for you.
          </motion.div>
        </motion.div>
      </section>
              ...
              <div style={{ padding: 'clamp(2rem, 5vw, 4rem)', minHeight: '260px', position: 'relative', backgroundColor: 'rgba(0,0,0,0.3)' }}>
                ...
                >
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 700 }}>
                    Re-taught by <span style={{ color: 'rgba(255,255,255,0.8)' }}>LearnAI</span>
                  </div>
                </motion.div>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 'clamp(0.95rem, 3vw, 1.15rem)', lineHeight: 1.8, color: 'var(--color-text-muted)', marginBottom: '1.5rem' }}>
              LearnAI doesn't invent curriculum—it decodes it. By isolating the core principles of your source material, it preserves 100% of the academic rigor while completely reinventing the delivery.
            </p>
      ...
      <section className="marketing-section">
        ...
        >
          ...
          <motion.div 
            ...
            style={{ gap: '2rem', textAlign: 'left', maxWidth: '64rem', margin: '0 auto' }}
            variants={staggerContainer}
          >
            <motion.div className="marketing-glass-card magnetic-card" variants={cardVariant}>
            ...
            <motion.div className="marketing-glass-card magnetic-card" variants={cardVariant}>
              ...
              <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', lineHeight: 1.6 }}>You need to build a 12-week curriculum and you have two weeks to do it. Use LearnAI as a first-draft engine, structured, well-written, and ready to edit.</p>
            </motion.div>
          ...
          <div style={{ fontSize: 'clamp(0.95rem, 3vw, 1.15rem)', lineHeight: 1.8, color: 'var(--color-text-muted)', display: 'flex', flexDirection: 'column', gap: '1.5rem', textAlign: 'center' }}>
            ...
            <div style={{ marginTop: '3.5rem', paddingTop: '3.5rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
              <p style={{ fontFamily: 'var(--font-sans)', color: '#f5efe6', fontWeight: 700, fontSize: '1.25rem', letterSpacing: '-0.02em' }}>
                That's what LearnAI is. Not a content library. A teaching layer. Built for the way you learn.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      {/* ACTUAL FOOTER */}
      <footer className="w-full relative z-10 bg-[#0D0907] px-6 py-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4">
          
          {/* Logo */}
          <div className="flex items-center justify-center gap-2 md:justify-start flex-1 w-full md:w-auto">
            <Logo size={20} />
            <span className="font-extrabold text-base text-[#f5efe6] tracking-tight">LearnAI</span>
          </div>

          {/* Links */}
          <div className="flex items-center justify-center gap-8 flex-1 w-full md:w-auto">
            {['Privacy', 'Terms', 'Contact'].map(link => (
              <a key={link} href="#" className="text-[#a09e9c] hover:text-white transition-colors text-sm no-underline">
                {link}
              </a>
            ))}
          </div>
          ...
          {/* Copyright */}
          <div className="text-white/30 text-xs text-center md:text-right flex-1 w-full md:w-auto">
            © 2025 LearnAI. Made for curious people.
          </div>
